...
% ============================================================================
% $RCSfile: plotXY.m,v $
% $Source: /home/kerfoot/cvsroot/slocum/matlab/spt/classes/@Dbd/plotXY.m,v $
% $Revision: 1.2 $
% $Date: 2013/09/19 15:29:11 $
% $Author: kerfoot $
% ============================================================================
% 
...
% Create the figure
tag = sprintf('%s_%s_vs-%s.png',...
    obj.segment,...
    regexprep(x_sensor, '_', '-'),...
    regexprep(y_sensor, '_', '-'));
...
title(sprintf('%s - %s UTC',...
    datestr(obj.startDatenum, 'yyyy-mm-dd HH:MM:SS'),...
    datestr(obj.endDatenum, 'yyyy-mm-dd HH:MM:SS')));
